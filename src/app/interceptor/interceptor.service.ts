...
export class InterceptorService implements HttpInterceptor {
  ...
  intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    const metodosAuth = [
      ...
      'usuario/MostrarPersonasAsistencias',
      ...
      'Produccion/MostrarOrdenCompraArima',
      'Produccion/MostrarOrdenCompraPrevios',
      'Produccion/VisualizarOrdenCompraSimulada',
      'Produccion/GenerarOrdenCompraDrogueria',
      'Produccion/RegistrarOrdenCompraDrogueria',
      'Produccion/InformacionSeguimientoCompraImportacion',
      'Produccion/ReporteSeguimientoCompraImportacionExcel',
      'Produccion/MostrarOrdenCompraNacionalImportacion',
      'Produccion/InformacionSeguimientoCompraCommodity',
      'Produccion/InformacionPedidoAguja',
      ...
      "GestionEquipoEngaste/ListarEquipoEngaste",
      ...
      "ComprobanteOrdenCompra/MostrarInformacionOrdenCompra",
      "ComprobanteOrdenCompra/RegistrarFechaPrometida",
      "ComprobanteOrdenCompra/MostrarDetalleOrdenCompra",
      "Encajado/listaOrdenesFabricacion",
      "Encajado/listaTransferenciasEncaje",
